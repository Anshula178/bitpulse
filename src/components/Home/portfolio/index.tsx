      ...
      <div className="container mx-auto lg:max-w-screen-xl px-4 sm:px-6">
        <div className="grid lg:grid-cols-2 items-center gap-20">
          ...
          >
            ...
            Track Your <span className="text-primary">Investments</span>
            </p>
            <h2 className="text-white sm:text-40 text-30 mb-4 font-medium">
              Create your crypto portfolio today with Bit
              <span className="text-primary">Pulse</span>!
            </h2>
            <p className="text-muted text-opacity-60 text-18">
            With powerful features, Coinbase is the perfect<br className="md:block hidden" /> place to start trading crypto.
            </p>
