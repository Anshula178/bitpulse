...
const Hero = () => {
  ...
  Access Crypto <span className="text-primary">Anywhere</span>
</p>

            </div>
            <h1 className="font-medium lg:text-76 md:text-70 text-54 lg:text-start text-center text-white mb-10">
            Discover & Trade <span className="text-primary">Crypto</span> of Your Choice!
</h1>
      ...
      <div className="absolute w-50 h-50 bg-gradient-to-bl from-cyan-300 from-50% to-cyan-800 to-60% blur-400 rounded-full -top-64 -right-14 -z-1"></div>
